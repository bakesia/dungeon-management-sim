...
PC 웹 전용 데이터 기반 던전 경영 시뮬레이션입니다. 현재 버전은 `v0.1.11`입니다.
...
- 조건/전조의 영속 해금과 독립 방문 pity를 거쳐 합류하는 6종 NPC와 상점·대장간·용병·영구 주민 모집·마력·치료·정보 기능
...
- Dexie autosave와 SAVE_VERSION 1~8 → 9 마이그레이션
