...
PC 웹 전용 데이터 기반 던전 경영 시뮬레이션입니다. 현재 버전은 `v0.1.7`입니다.
...
- 안전 기간 이후 누적되는 위협도와 100 강제 침입을 적용하는 자동 방어 판정
- 전조 사건과 Special Visitor를 거쳐 합류하는 6종 NPC와 상점·대장간·용병·마력·치료·정보 기능
