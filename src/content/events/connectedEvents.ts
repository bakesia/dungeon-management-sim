...
export const connectedEventDefinitions: EventDefinition[] = [
  ...
  },
  {
    ...
    choices: [
      { id: 'keep', text: '금화를 운영비로 쓴다', effects: [{ type: 'addResource', resourceId: 'gold', amount: 11 }, { type: 'changeThreat', amount: 4 }, { type: 'addLog', category: 'resource', message: '금화를 챙겼지만 누군가 흔적을 좇기 시작했습니다. [골드 +11, 위협 +4]' }] },
      ...
      { id: 'leave', text: '원래 자리에 돌려놓는다', effects: [{ type: 'changeThreat', amount: -3 }, { type: 'addLog', category: 'event', message: '수상한 물건을 건드리지 않아 흔적을 줄였습니다. [위협 -3]' }] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { id: 'erase', text: '흔적을 지우고 입구를 위장한다', conditions: [{ type: 'resourceAtLeast', resourceId: 'material', amount: 4 }], effects: [{ type: 'addResource', resourceId: 'material', amount: -4 }, { type: 'changeThreat', amount: -6 }, { type: 'addLog', category: 'invasion', message: '입구 흔적을 지웠습니다. [자재 -4, 위협 -6]' }] },
      { id: 'informant', text: '정보상에게 추적을 맡긴다', conditions: [{ type: 'npcJoined', npcId: 'npc_informant', value: true }], effects: [{ type: 'revealInvasionIntel', intelType: 'invaderCategory' }, { type: 'changeThreat', amount: -5 }, { type: 'addLog', category: 'invasion', message: '정보상이 발자국의 주인과 이동 방향을 밝혔습니다. [위협 -5]' }] },
      { id: 'follow', text: '역으로 추적한다', effects: [{ type: 'setFlag', flag: 'intelligence_network_seed', value: true }, { type: 'changeThreat', amount: 5 }, { type: 'addLog', category: 'invasion', message: '위험을 감수하고 외부 연락망의 흔적을 확보했습니다. [위협 +5]' }] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { id: 'salvage', text: '자재로 분해한다', effects: [{ type: 'addResource', resourceId: 'material', amount: 10 }, { type: 'changeThreat', amount: 3 }, { type: 'addLog', category: 'resource', message: '장비를 분해했습니다. [자재 +10, 위협 +3]' }] },
      ...
      { id: 'bait', text: '가짜 흔적으로 활용한다', effects: [{ type: 'changeThreat', amount: -5 }, { type: 'addLog', category: 'invasion', message: '장비를 미끼로 두어 추적자를 다른 길로 유도했습니다. [위협 -5]' }] },
    ],
  },
  {
    ...
    choices: [
      ...
      { id: 'tavern', text: '펍 주인이 소문의 출처를 대조한다', conditions: [{ type: 'npcJoined', npcId: 'npc_tavern_keeper', value: true }], effects: [{ type: 'changeThreat', amount: -4 }, { type: 'addResource', resourceId: 'gold', amount: 3 }, { type: 'addLog', category: 'resource', message: '거짓 소문을 걸러내고 정보값도 챙겼습니다. [위협 -4, 골드 +3]' }] },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'charge', text: '숙박비를 받는다', effects: [{ type: 'addResource', resourceId: 'gold', amount: 12 }, { type: 'changeThreat', amount: 8 }, { type: 'addLog', category: 'warning', message: '숙박비를 받았지만 떠들썩한 소문이 퍼졌습니다. [골드 +12, 위협 +8]' }] },
  ...
  },
  {
    ...
    choices: [
      { id: 'treat', text: '식량과 붕대를 내어준다', conditions: [{ type: 'resourceAtLeast', resourceId: 'food', amount: 8 }], effects: [{ type: 'addResource', resourceId: 'food', amount: -8 }, { type: 'setFlag', flag: 'compassionate_dungeon', value: true }, { type: 'changeThreat', amount: -4 }, { type: 'addLog', category: 'event', message: '여행자를 치료해 돌려보냈습니다. [식량 -8, 위협 -4]' }] },
      { id: 'search', text: '소지품만 챙겨 내보낸다', effects: [{ type: 'addResource', resourceId: 'gold', amount: 10 }, { type: 'changeThreat', amount: 7 }, { type: 'addLog', category: 'warning', message: '소지품을 챙겼지만 좋지 않은 소문이 퍼졌습니다. [골드 +10, 위협 +7]' }] },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { id: 'sell', text: '장물아비에게 넘긴다', effects: [{ type: 'addResource', resourceId: 'gold', amount: 9 }, { type: 'changeThreat', amount: 5 }, { type: 'addLog', category: 'warning', message: '문서를 팔았지만 정보가 새어 나갔습니다. [골드 +9, 위협 +5]' }] },
    ],
  },
  {
